...
- Implemented and tested a [health](https://github.com/Theo3699/Java/blob/main/lab10/src/main/java/ro/theo/MyLivenessCheck.java) check procedure, in order to determine the readiness and the liveness of your service.
